...
def expected_plot_paths() -> list[Path]:
    return [
        ...
        REPO_ROOT / "output" / "comparison" / "figure2_comparison.png",
        REPO_ROOT / "output" / "comparison" / "comparison_results.json",
    ]
...
def run_plots_step(python_bin: str, device: str) -> None:
    ...
    run_command([python_bin, "scripts/plot_canonical_synthetic_comparison.py"])
...
def build_manifest() -> dict:
    ...
    return {
        ...
        "notes": {
            ...
            "figure2_source": "output/comparison/figure2_comparison.png is regenerated directly from the saved canonical eval_results.json files by scripts/plot_canonical_synthetic_comparison.py.",
        },
    }
